...
public class PosGuiUtil {
	...
	public static String getMultilineHtml(String value) {
		/**
		 * Convert string with `\n` line breakers to html.
		 */
		return "<html>" + value.replaceAll("\\n", "<br>") + "</html>";
	}
	
	public static String getCenteredMultilineHtml(String value) {
		/**
		 * Convert string with `\n` line breakers to html.
		 * Centers text.
		 */
		return "<html><center>" + value.replaceAll("\\n", "<br>") + "</center></html>";
	}
}
