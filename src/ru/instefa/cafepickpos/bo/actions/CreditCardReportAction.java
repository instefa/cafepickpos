...
import ru.instefa.cafepickpos.report.CreditCardReportView;

public class CreditCardReportAction extends AbstractAction {

	public CreditCardReportAction() {
		super(ru.instefa.cafepickpos.POSConstants.CREDIT_CARD_REPORT);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		int index = tabbedPane.indexOfTab(ru.instefa.cafepickpos.POSConstants.CREDIT_CARD_REPORT);
		if (index == -1) {
			reportView = new CreditCardReportView();
			tabbedPane.addTab(ru.instefa.cafepickpos.POSConstants.CREDIT_CARD_REPORT, reportView);
		}
		else {
