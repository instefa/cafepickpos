...
public class SalesAnalysisReportAction extends AbstractAction {
	...
	public SalesAnalysisReportAction() {
		super(ru.instefa.cafepickpos.POSConstants.SALES_ANALYSIS);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		int index = tabbedPane.indexOfTab(ru.instefa.cafepickpos.POSConstants.SALES_ANALYSIS);
		if (index == -1) {
			reportView = new SalesSummaryReportView();
			reportView.setReportType(SalesSummaryReportView.REPORT_SALES_ANALYSIS);
			tabbedPane.addTab(ru.instefa.cafepickpos.POSConstants.SALES_ANALYSIS, reportView);
		}
		else {
