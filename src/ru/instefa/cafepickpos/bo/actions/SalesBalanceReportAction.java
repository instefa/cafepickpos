...
import ru.instefa.cafepickpos.report.SalesBalanceReportView;

public class SalesBalanceReportAction extends AbstractAction {

	public SalesBalanceReportAction() {
		super(ru.instefa.cafepickpos.POSConstants.SALES_BALANCE_REPORT);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		int index = tabbedPane.indexOfTab(ru.instefa.cafepickpos.POSConstants.SALES_BALANCE_REPORT);
		if (index == -1) {
			reportView = new SalesBalanceReportView();
			tabbedPane.addTab(ru.instefa.cafepickpos.POSConstants.SALES_BALANCE_REPORT, reportView);
		}
		else {
