...
import ru.instefa.cafepickpos.report.OpenTicketSummaryReport;
...
public class OpenTicketSummaryReportAction extends AbstractAction {
	...
	public OpenTicketSummaryReportAction() {
		super(ru.instefa.cafepickpos.POSConstants.OPEN_TICKET_SUMMARY);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		int index = tabbedPane.indexOfTab(ru.instefa.cafepickpos.POSConstants.OPEN_TICKET_SUMMARY);
		if (index == -1) {
			viewer = new ReportViewer(new OpenTicketSummaryReport());
			tabbedPane.addTab(ru.instefa.cafepickpos.POSConstants.OPEN_TICKET_SUMMARY_REPORT, viewer);
		}
		else {
