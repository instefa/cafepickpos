...
import ru.instefa.cafepickpos.bo.ui.explorer.MenuCategoryExplorer;

public class CategoryExplorerAction extends AbstractAction {

	public CategoryExplorerAction() {
		super(ru.instefa.cafepickpos.POSConstants.MENU_CATEGORIES);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		int index = tabbedPane.indexOfTab(ru.instefa.cafepickpos.POSConstants.CATEGORY_EXPLORER);
		if (index == -1) {
			explorer = new MenuCategoryExplorer();
			tabbedPane.addTab(ru.instefa.cafepickpos.POSConstants.CATEGORY_EXPLORER, explorer);
		}
		else {
