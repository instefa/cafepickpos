...
import ru.instefa.cafepickpos.bo.ui.explorer.PizzaExplorer;

public class PizzaExplorerAction extends AbstractAction {

	public PizzaExplorerAction() {
		super(Messages.getString("PizzaExplorerAction.0"));
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (index == -1) {
			...
			tabbedPane.addTab(Messages.getString("PizzaExplorerAction.0"), explorer);
		}
		else {
