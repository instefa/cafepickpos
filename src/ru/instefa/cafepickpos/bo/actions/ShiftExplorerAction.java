...
import ru.instefa.cafepickpos.bo.ui.explorer.ShiftExplorer;

public class ShiftExplorerAction extends AbstractAction {

	public ShiftExplorerAction() {
		super(ru.instefa.cafepickpos.POSConstants.SHIFTS);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		int index = tabbedPane.indexOfTab(ru.instefa.cafepickpos.POSConstants.SHIFTS);
		if (index == -1) {
			explorer = new ShiftExplorer();
			tabbedPane.addTab(ru.instefa.cafepickpos.POSConstants.SHIFTS, explorer);
		}
		else {
