...
import ru.instefa.cafepickpos.bo.ui.explorer.CookingInstructionExplorer;

public class CookingInstructionExplorerAction extends AbstractAction {

	public CookingInstructionExplorerAction() {
		super(ru.instefa.cafepickpos.POSConstants.COOKING_INSTRUCTIONS);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		int index = tabbedPane.indexOfTab(ru.instefa.cafepickpos.POSConstants.COOKING_INSTRUCTIONS);
		if (index == -1) {
			explorer = new CookingInstructionExplorer();
			tabbedPane.addTab(ru.instefa.cafepickpos.POSConstants.COOKING_INSTRUCTIONS, explorer);
		}
		else {
