...
import ru.instefa.cafepickpos.report.SalesSummaryReportView;

public class KeyStatisticsSalesReportAction extends AbstractAction {

	public KeyStatisticsSalesReportAction() {
		super(ru.instefa.cafepickpos.POSConstants.SALES_SUMMARY_KEY_STATISTICS_REPORT);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		int index = tabbedPane.indexOfTab(ru.instefa.cafepickpos.POSConstants.SALES_SUMMARY_KEY_STATISTICS);
		if (index == -1) {
			reportView = new SalesSummaryReportView();
			reportView.setReportType(SalesSummaryReportView.REPORT_KEY_STATISTICS);
			tabbedPane.addTab(ru.instefa.cafepickpos.POSConstants.SALES_SUMMARY_KEY_STATISTICS, reportView);
		}
		else {
