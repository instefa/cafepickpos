...
import ru.instefa.cafepickpos.bo.ui.explorer.UserTypeExplorer;

public class UserTypeExplorerAction extends AbstractAction {

	public UserTypeExplorerAction() {
		super(ru.instefa.cafepickpos.POSConstants.USER_TYPES);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		int index = tabbedPane.indexOfTab(ru.instefa.cafepickpos.POSConstants.USER_TYPE_EXPLORER);
		if (index == -1) {
			explorer = new UserTypeExplorer();
			tabbedPane.addTab(ru.instefa.cafepickpos.POSConstants.USER_TYPE_EXPLORER, explorer);
		}
		else {
