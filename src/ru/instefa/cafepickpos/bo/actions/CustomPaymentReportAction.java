...
import ru.instefa.cafepickpos.report.CustomPaymentReportView;

public class CustomPaymentReportAction extends AbstractAction {

	public CustomPaymentReportAction() {
		super(ru.instefa.cafepickpos.POSConstants.CUSTOM_PAYMENT_REPORT);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		int index = tabbedPane.indexOfTab(ru.instefa.cafepickpos.POSConstants.CUSTOM_PAYMENT_REPORT);
		if (index == -1) {
			reportView = new CustomPaymentReportView();
			tabbedPane.addTab(ru.instefa.cafepickpos.POSConstants.CUSTOM_PAYMENT_REPORT, reportView);
		}
		else {
