...
import ru.instefa.cafepickpos.bo.ui.explorer.DrawerPullReportExplorer;

public class DrawerPullReportExplorerAction extends AbstractAction {

	public DrawerPullReportExplorerAction() {
		super(ru.instefa.cafepickpos.POSConstants.DRAWER_PULL_REPORTS);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		int index = tabbedPane.indexOfTab(ru.instefa.cafepickpos.POSConstants.DRAWER_PULL_REPORTS);
		if (index == -1) {
			explorer = new DrawerPullReportExplorer();
			tabbedPane.addTab(ru.instefa.cafepickpos.POSConstants.DRAWER_PULL_REPORTS, explorer);
		}
		else {
