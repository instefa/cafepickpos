...
import ru.instefa.cafepickpos.report.SalesDetailReportView;

public class SalesDetailReportAction extends AbstractAction {

	public SalesDetailReportAction() {
		super(ru.instefa.cafepickpos.POSConstants.SALES_DETAILED_REPORT);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		int index = tabbedPane.indexOfTab(ru.instefa.cafepickpos.POSConstants.SALES_DETAILED_REPORT);
		if (index == -1) {
			reportView = new SalesDetailReportView();
			tabbedPane.addTab(ru.instefa.cafepickpos.POSConstants.SALES_DETAILED_REPORT, reportView);
		}
		else {
