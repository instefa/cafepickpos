...
import ru.instefa.cafepickpos.bo.ui.explorer.UserExplorer;

public class UserExplorerAction extends AbstractAction {

	public UserExplorerAction() {
		super(ru.instefa.cafepickpos.POSConstants.USERS);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		int index = tabbedPane.indexOfTab(ru.instefa.cafepickpos.POSConstants.USERS);
		if (index == -1) {
			explorer = new UserExplorer();
			tabbedPane.addTab(ru.instefa.cafepickpos.POSConstants.USERS, explorer);
		}
		else {
