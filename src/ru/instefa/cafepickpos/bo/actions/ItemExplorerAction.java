...
import ru.instefa.cafepickpos.bo.ui.explorer.MenuItemExplorer;

public class ItemExplorerAction extends AbstractAction {

	public ItemExplorerAction() {
		super(ru.instefa.cafepickpos.POSConstants.MENU_ITEMS);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		int index = tabbedPane.indexOfTab(ru.instefa.cafepickpos.POSConstants.ITEM_EXPLORER);
		if (index == -1) {
			item = new MenuItemExplorer();
			tabbedPane.addTab(ru.instefa.cafepickpos.POSConstants.ITEM_EXPLORER, item);
		}
		else {
