...
import ru.instefa.cafepickpos.report.ServerProductivityReportView;

public class ServerProductivityReportAction extends AbstractAction {

	public ServerProductivityReportAction() {
		super(ru.instefa.cafepickpos.POSConstants.SERVER_PRODUCTIVITY_REPORT);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		int index = tabbedPane.indexOfTab(ru.instefa.cafepickpos.POSConstants.SERVER_PRODUCTIVITY_REPORT);
		if (index == -1) {
			reportView = new ServerProductivityReportView();
			tabbedPane.addTab(ru.instefa.cafepickpos.POSConstants.SERVER_PRODUCTIVITY_REPORT, reportView);
		}
		else {
