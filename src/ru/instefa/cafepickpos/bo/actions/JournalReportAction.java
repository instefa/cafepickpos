...
import ru.instefa.cafepickpos.report.JournalReportView;

public class JournalReportAction extends AbstractAction {

	public JournalReportAction() {
		super(ru.instefa.cafepickpos.POSConstants.JOURNAL_REPORT);
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		int index = tabbedPane.indexOfTab(ru.instefa.cafepickpos.POSConstants.JOURNAL_REPORT);
		if (index == -1) {
			reportView = new JournalReportView();
			tabbedPane.addTab(ru.instefa.cafepickpos.POSConstants.JOURNAL_REPORT, reportView);
		}
		else {
