...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        label1.setText(ru.instefa.cafepickpos.POSConstants.SELECT_USER + POSConstants.COLON);
        ...
        label2.setText(ru.instefa.cafepickpos.POSConstants.USER_ID + POSConstants.COLON);
        ...
        label3.setText(ru.instefa.cafepickpos.POSConstants.USER_NAME + POSConstants.COLON);
        ...
        label4.setText(ru.instefa.cafepickpos.POSConstants.TOTAL_GRATUITY + POSConstants.COLON);
        ...
        label5.setText(ru.instefa.cafepickpos.POSConstants.DETAILS);
        ...
        btnPay = new JButton();
        btnPay.setText(ru.instefa.cafepickpos.POSConstants.PAY);
    ...
    private class GratuityTableModel extends ListTableModel {
        ...
        public GratuityTableModel(List<Gratuity> gratuities) {
            super(new String[]{ru.instefa.cafepickpos.POSConstants.FIRST_NAME, ru.instefa.cafepickpos.POSConstants.LAST_NAME, ru.instefa.cafepickpos.POSConstants.TICKET_ID, ru.instefa.cafepickpos.POSConstants.AMOUNT}, gratuities);
        }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (ru.instefa.cafepickpos.POSConstants.GO.equalsIgnoreCase(actionCommand)) {
        ...
        if (ru.instefa.cafepickpos.POSConstants.PAY.equalsIgnoreCase(actionCommand)) {
            try {
...
//				PAY TIPS ACTION
                String actionMessage = ru.instefa.cafepickpos.POSConstants.PAY_TIPS;
