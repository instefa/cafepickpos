...
import ru.instefa.cafepickpos.ui.model.ShiftEntryDialog;
...
public class ShiftExplorer extends TransparentPanel {
		...
		deleteButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (ConfirmDeleteDialog.showMessage(ShiftExplorer.this, ru.instefa.cafepickpos.POSConstants.CONFIRM_DELETE, ru.instefa.cafepickpos.POSConstants.DELETE) == ConfirmDeleteDialog.YES) {
	...
	class ShiftTableModel extends ListTableModel {
		...
		ShiftTableModel(List list){
			super(new String[] {ru.instefa.cafepickpos.POSConstants.ID, ru.instefa.cafepickpos.POSConstants.NAME, ru.instefa.cafepickpos.POSConstants.START_TIME, ru.instefa.cafepickpos.POSConstants.END_TIME}, list);
		}
