...
import ru.instefa.cafepickpos.ui.forms.UserTypeForm;
...
public class UserTypeExplorer extends TransparentPanel {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (ConfirmDeleteDialog
							.showMessage(UserTypeExplorer.this, ru.instefa.cafepickpos.POSConstants.CONFIRM_DELETE, ru.instefa.cafepickpos.POSConstants.DELETE) == ConfirmDeleteDialog.YES) {
	...
	class UserTypeExplorerTableModel extends AbstractTableModel {
		String[] columnNames = { ru.instefa.cafepickpos.POSConstants.TYPE_NAME, ru.instefa.cafepickpos.POSConstants.PERMISSIONS };
