...
import ru.instefa.cafepickpos.ui.model.MultiplierForm;
...
public class MultiplierExplorer extends TransparentPanel {
	...
	public MultiplierExplorer() {
		...
		editButton = new JButton(ru.instefa.cafepickpos.POSConstants.EDIT);
		...
		deleteButton = new JButton(ru.instefa.cafepickpos.POSConstants.DELETE);
		deleteButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (multiplier.isMain())
						return;
					if (ConfirmDeleteDialog.showMessage(MultiplierExplorer.this, ru.instefa.cafepickpos.POSConstants.CONFIRM_DELETE,
		...
		JButton btnSetAsDefault = new JButton(Messages.getString("MultiplierExplorer.0"));
	...
	class MultiplierExplorerTableModel extends AbstractTableModel {
		String[] columnNames = {
				POSConstants.NAME, Messages.getString("MultiplierExplorer.1"), POSConstants.RATE,
				POSConstants.SORT_ORDER, POSConstants.BUTTON_COLOR, POSConstants.TEXT_COLOR,
				Messages.getString("MultiplierExplorer.2")
			};
