...
import ru.instefa.cafepickpos.ui.model.PizzaItemForm;
...
public class PizzaItemExplorer extends TransparentPanel {
	...
	private JPanel buildSearchForm() {
		...
		try {
			...
			TitledBorder title = BorderFactory.createTitledBorder(loweredetched, Messages.getString("MenuItemExplorer.3")); //$NON-NLS-1$
