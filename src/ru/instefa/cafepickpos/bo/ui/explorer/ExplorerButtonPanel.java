...
public class ExplorerButtonPanel extends TransparentPanel {
	...
	private void initComponents() {
		...
		editButton.setText(ru.instefa.cafepickpos.POSConstants.EDIT);
		addButton.setText(ru.instefa.cafepickpos.POSConstants.ADD);
		deleteButton.setText(ru.instefa.cafepickpos.POSConstants.DELETE);
