...
public class MenuItemExplorer extends TransparentPanel {
	...
	private JPanel buildSearchForm() {
		...
		cbOrderTypes.addItem(Messages.getString("MenuItemExplorer.26"));
		...
		try {
			...
			cbGroup.addItem(Messages.getString("MenuItemExplorer.26"));
			...
			TitledBorder title = BorderFactory.createTitledBorder(loweredetched,
					Messages.getString("MenuItemExplorer.3")); //$NON-NLS-1$
	...
	private TransparentPanel createButtonPanel() {
		...
		JButton btnChangeMenuGroup = new JButton(Messages.getString("MenuItemExplorer.27"));
		JButton btnChangeOrderType = new JButton(Messages.getString("MenuItemExplorer.28"));
		...
		deleteButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (POSMessageDialog.showYesNoQuestionDialog(MenuItemExplorer.this,
	...
	protected MenuGroup getSelectedMenuGroup(MenuGroup defaultValue) {
		...
		ComboItemSelectionDialog dialog = new ComboItemSelectionDialog(Messages.getString("MenuGroupForm.34"),
				Messages.getString("MenuItemExplorer.28"), menuGroups, false);
	...
	protected List<OrderType> getSelectedOrderTypes(List defaultValues) {
		...
		ComboItemSelectionDialog dialog = new ComboItemSelectionDialog(Messages.getString("MenuItemExplorer.30"),
				POSConstants.ORDER_TYPE, orderTypes, true);
