...
import ru.instefa.cafepickpos.ui.model.CurrencyForm;
...
public class CurrencyExplorer extends TransparentPanel {
	...
	public CurrencyExplorer() {
		...
		tableModel.addColumn(Messages.getString("CurrencyExplorer.0"), "code"); //$NON-NLS-1$
		tableModel.addColumn(Messages.getString("CurrencyExplorer.1"), "symbol"); //$NON-NLS-1$
		tableModel.addColumn(Messages.getString("CurrencyExplorer.2"), "exchangeRate"); //$NON-NLS-1$
		tableModel.addColumn(Messages.getString("CurrencyExplorer.3"), "main"); //$NON-NLS-1$
		tableModel.addColumn(Messages.getString("CurrencyExplorer.4"), "tolerance"); //$NON-NLS-1$
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (ConfirmDeleteDialog.showMessage(POSUtil.getBackOfficeWindow(),
							ru.instefa.cafepickpos.POSConstants.CONFIRM_DELETE,
