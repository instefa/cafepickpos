...
import ru.instefa.cafepickpos.ui.model.MenuModifierForm;
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (ConfirmDeleteDialog
							.showMessage(ModifierExplorer.this, ru.instefa.cafepickpos.POSConstants.CONFIRM_DELETE, ru.instefa.cafepickpos.POSConstants.DELETE) != ConfirmDeleteDialog.NO) {
