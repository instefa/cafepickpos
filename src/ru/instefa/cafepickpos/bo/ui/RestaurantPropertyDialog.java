...
public class RestaurantPropertyDialog extends POSDialog {
	...
	public RestaurantPropertyDialog() {
		...
		setTitle(ru.instefa.cafepickpos.POSConstants.CONFIGURE);
	...
	private void initComponents() {
		...
		jLabel1.setText(ru.instefa.cafepickpos.POSConstants.RESTAURANT_NAME + POSConstants.COLON);

		jLabel2.setText(ru.instefa.cafepickpos.POSConstants.ADDRESS_LINE1 + POSConstants.COLON);

		jLabel3.setText(ru.instefa.cafepickpos.POSConstants.ADDRESS_LINE2 + POSConstants.COLON);

		jLabel4.setText(ru.instefa.cafepickpos.POSConstants.CAPACITY + POSConstants.COLON);

		jLabel5.setText(ru.instefa.cafepickpos.POSConstants.TABLES + POSConstants.COLON);

		btnCancel.setText(ru.instefa.cafepickpos.POSConstants.CLOSE);
		...
		btnOk.setText(ru.instefa.cafepickpos.POSConstants.SAVE);
	...
	private void doSave(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_doSave
		try {
			...
			try {
				...
				POSMessageDialog.showError(this, ru.instefa.cafepickpos.POSConstants.CAPACITY_IS_NOT_VALID_);
				return;
			}
			...
			try {
				...
				POSMessageDialog.showError(this, ru.instefa.cafepickpos.POSConstants.NUMBER_OF_TABLES_IS_NOT_VALID);
				return;
			}
