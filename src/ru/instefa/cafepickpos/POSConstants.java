...
public class POSConstants {
	...
	public static final String SELECT_CRITERIA = Messages.getString("PosMessage.183"); //$NON-NLS-1$
	...
	public static final String PAYMENT_STATUS_FILTER_CLOSED = Messages.getString("PAYMENT_STATUS_FILTER_CLOSED"); //$NON-NLS-1$
	// 20170710, pymancer, previous and next buttons
	public static final String BUTTON_TEXT_PREVIOUS = Messages.getString("BUTTON_TEXT_PREVIOUS"); //$NON-NLS-1$
	public static final String BUTTON_TEXT_NEXT = Messages.getString("BUTTON_TEXT_NEXT"); //$NON-NLS-1$
	// 20170713, pymancer, translating selectable as default views
	public static final String KD = Messages.getString("KD"); //$NON-NLS-1$
	public static final String ALL_FUNCTIONS = Messages.getString("ALL_FUNCTIONS"); //$NON-NLS-1$
    // 20170726, pymancer, bookings view
    public static final String BOOKING = Messages.getString("BOOKING"); //$NON-NLS-1$
    // pymancer, common capitalized 'Time' label
    public static final String TIME_CAPITALIZED = Messages.getString("PosMessage.312"); //$NON-NLS-1$
    // pymancer, common 'ORDER' label
    public static final String ORDER = Messages.getString("PosMessage.313"); //$NON-NLS-1$
}
