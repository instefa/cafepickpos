...
public class PrintConfigurationView extends ConfigurationView {
	...
	private JCheckBox chkKitchenBtn = new JCheckBox(Messages.getString("PrintConfigurationView.14"));
	...
	public String getName() {
		return ru.instefa.cafepickpos.POSConstants.CONFIG_TAB_PRINT;
	}
	...
	public void initialize() throws Exception {
		...
		if (printServices == null || printServices.length == 0) {
			POSMessageDialog.showMessage(ru.instefa.cafepickpos.util.POSUtil.getFocusedWindow(),
	...
	private void initComponents() {
		...
		MultiPrinterPane multiPrinterPane = new MultiPrinterPane(Messages.getString("PrintConfigurationView.15"),
																 printers.getKitchenPrinters()); //$NON-NLS-1$
