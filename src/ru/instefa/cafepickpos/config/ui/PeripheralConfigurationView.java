...
import ru.instefa.cafepickpos.util.SerialPortUtil;

public class PeripheralConfigurationView extends ConfigurationView {
	public static final String CONFIG_TAB_PERIPHERAL = Messages.getString("PeripheralConfigurationView.25"); //$NON-NLS-1$
	...
	private void initComponents() {
		...
		JButton btnDrawerTest = new JButton(Messages.getString("PeripheralConfigurationView.7")); //$NON-NLS-1$
