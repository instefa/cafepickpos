...
public class PurchaseReportView extends TransparentPanel {
	...
	public PurchaseReportView() {
		...
		// String[]{ru.instefa.cafepickpos.POSConstants.ALL,
		// ru.instefa.cafepickpos.POSConstants.SERVER,
		// ru.instefa.cafepickpos.POSConstants.CASHIER,
		// ru.instefa.cafepickpos.POSConstants.MANAGER}));
	...
	private void viewReport(List<InventoryItem> inventList) {
		...
		try {
			...
			properties.put("reportTitle", Messages.getString("PurchaseReportView.0"));
