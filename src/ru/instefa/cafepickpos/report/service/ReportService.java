 ...
 * ************************************************************************
 */
package ru.instefa.cafepickpos.report.service;
...
import ru.instefa.cafepickpos.model.CreditCardTransaction;
...
import ru.instefa.cafepickpos.report.JournalReportModel;
import ru.instefa.cafepickpos.report.JournalReportModel.JournalReportData;
import ru.instefa.cafepickpos.report.MenuUsageReport;
import ru.instefa.cafepickpos.report.MenuUsageReport.MenuUsageReportData;
import ru.instefa.cafepickpos.report.SalesBalanceReport;
import ru.instefa.cafepickpos.report.SalesDetailedReport;
import ru.instefa.cafepickpos.report.SalesExceptionReport;
import ru.instefa.cafepickpos.report.SalesDetailedReport.DrawerPullData;
import ru.instefa.cafepickpos.report.ServerProductivityReport;
import ru.instefa.cafepickpos.report.ServerProductivityReport.ServerProductivityReportData;

public class ReportService {
    // 20170714, pymancer 24 hour clock format option
	private static SimpleDateFormat fullDateFormatter = new SimpleDateFormat(DateUtil.getDatePattern("MMM dd yyyy, hh:mm a")); //$NON-NLS-1$
	...
	public MenuUsageReport getMenuUsageReport(Date fromDate, Date toDate) {
		...
		try {
			...
			miscCategory.setName(ru.instefa.cafepickpos.POSConstants.MISC_BUTTON_TEXT);
