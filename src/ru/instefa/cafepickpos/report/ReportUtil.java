...
public class ReportUtil {
	...
	private final static String DEFAULT_REPORT_DIR = "/ru/instefa/cafepickpos/report/template/"; //$NON-NLS-1$
	...
	public static JasperReport getReport(String reportName) {
		...
		try {
			...
			logger.info(Messages.getString("ReportUtil.8") + " " + reportName + " " + Messages.getString("ReportUtil.9")); //$NON-NLS-1$ //$NON-NLS-2$
