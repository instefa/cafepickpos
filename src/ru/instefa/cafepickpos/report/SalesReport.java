...
public class SalesReport extends Report {
	...
	public void refresh() throws Exception {
		...
		map.put("dateRange", ReportService.formatShortDate(getStartDate()) + " " +
				Messages.getString("SalesReport.6") + " " +
				ReportService.formatShortDate(getEndDate()));
		map.put("terminalName", getTerminal() == null ? ru.instefa.cafepickpos.POSConstants.ALL : getTerminal().getName()); //$NON-NLS-1$
