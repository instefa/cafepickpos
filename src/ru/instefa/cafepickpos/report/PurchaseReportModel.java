...
public class PurchaseReportModel extends ListTableModel {
	...
	SimpleDateFormat dateFormat2 = new SimpleDateFormat(DateUtil.getDatePattern("MMM-dd-yyyy hh:mm a")); //$NON-NLS-1$
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		switch (columnIndex) {
			...
			case 4:
				return String.valueOf(data.getAveragePackagePrice());
