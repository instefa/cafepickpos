...
public class InventoryOnHandReportView extends TransparentPanel {
	...
	public InventoryOnHandReportView() {
		//cbUserType.setModel(new DefaultComboBoxModel(new String[]{ru.instefa.cafepickpos.POSConstants.ALL, ru.instefa.cafepickpos.POSConstants.SERVER, ru.instefa.cafepickpos.POSConstants.CASHIER, ru.instefa.cafepickpos.POSConstants.MANAGER}));
	...
	private void viewReport(List<InventoryItem> inventList) {
		...
		try {
			...
			properties.put("reportTitle", Messages.getString("InventoryOnHandReportView.0"));
	...
	private void $$$setupUI$$$() {
		...
		//label3.setText(ru.instefa.cafepickpos.POSConstants.TERMINAL);
		...
		//label4.setText(ru.instefa.cafepickpos.POSConstants.USER_TYPE_);
