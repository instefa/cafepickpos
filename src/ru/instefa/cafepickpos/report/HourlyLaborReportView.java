...
import ru.instefa.cafepickpos.model.dao.AttendenceHistoryDAO;
...
public class HourlyLaborReportView extends TransparentPanel {
	...
	private void viewReport() {
		...
		try {
			...
			properties.put("reportTitle", ru.instefa.cafepickpos.POSConstants.HOURLY_LABOR_REPORT); //$NON-NLS-1$
			...
			// 20170901, pymancer, report variable should not be translated
			properties.put("type", ru.instefa.cafepickpos.POSConstants.BY_RANGE_ACTUAL);
			properties.put("dept", userType == null ? ru.instefa.cafepickpos.POSConstants.ALL : userType.getName()); //$NON-NLS-1$
			properties.put("incr", Messages.getString("HourlyLaborReportView.0")); //$NON-NLS-1$ //$NON-NLS-2$
			properties.put("cntr", terminal == null ? ru.instefa.cafepickpos.POSConstants.ALL : terminal.getName()); //$NON-NLS-1$
	...
	private void $$$setupUI$$$() {
		...
		label1.setText(ru.instefa.cafepickpos.POSConstants.FROM + ":"); //$NON-NLS-1$
		...
		label2.setText(ru.instefa.cafepickpos.POSConstants.TO + ":"); //$NON-NLS-1$
		...
		label3.setText(ru.instefa.cafepickpos.POSConstants.TERMINAL_LABEL);
		...
		label4.setText(ru.instefa.cafepickpos.POSConstants.USER_TYPE + ":"); //$NON-NLS-1$
