...
import ru.instefa.cafepickpos.model.TipsCashoutReportTableModel;
import ru.instefa.cafepickpos.model.dao.RestaurantDAO;
import ru.instefa.cafepickpos.report.ReceiptPrintService;
import ru.instefa.cafepickpos.report.ReportUtil;
...
public class PosPrintService {
	...
	public static void printDrawerPullReport(DrawerPullReport drawerPullReport, Terminal terminal) {
		...
		try {
			...
			parameters.put("terminal", Messages.getString("PosPrintService.5") + " " + terminal.getId()); //$NON-NLS-1$ //$NON-NLS-2$
