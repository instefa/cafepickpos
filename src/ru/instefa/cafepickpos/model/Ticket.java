...
import ru.instefa.cafepickpos.model.base.BaseTicket;
...
public class Ticket extends BaseTicket {
	...
	private static SimpleDateFormat dateFormat = new SimpleDateFormat(DateUtil.getDatePattern("MMM dd yyyy, h:m a")); //$NON-NLS-1$
