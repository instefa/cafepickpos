...
public abstract class BaseInventoryTransaction  implements Comparable, Serializable {
	...
	// many to one
	private ru.instefa.cafepickpos.model.PurchaseOrder referenceNo;
	private ru.instefa.cafepickpos.model.InventoryItem inventoryItem;
	private ru.instefa.cafepickpos.model.InventoryVendor vendor;
	private ru.instefa.cafepickpos.model.InventoryWarehouse fromWarehouse;
	private ru.instefa.cafepickpos.model.InventoryWarehouse toWarehouse;
	 ...
	 */
	public ru.instefa.cafepickpos.model.PurchaseOrder getReferenceNo () {
					return referenceNo;
			}
	 ...
	 */
	public void setReferenceNo (ru.instefa.cafepickpos.model.PurchaseOrder referenceNo) {
	 ...
	 */
	public ru.instefa.cafepickpos.model.InventoryItem getInventoryItem () {
	 ...
	 */
	public void setInventoryItem (ru.instefa.cafepickpos.model.InventoryItem inventoryItem) {
	 ...
	 */
	public ru.instefa.cafepickpos.model.InventoryVendor getVendor () {
					return vendor;
			}
	 ...
	 */
	public void setVendor (ru.instefa.cafepickpos.model.InventoryVendor vendor) {
		this.vendor = vendor;
	}
	 ...
	 */
	public ru.instefa.cafepickpos.model.InventoryWarehouse getFromWarehouse () {
	 ...
	 */
	public void setFromWarehouse (ru.instefa.cafepickpos.model.InventoryWarehouse fromWarehouse) {
	 ...
	 */
	public ru.instefa.cafepickpos.model.InventoryWarehouse getToWarehouse () {
					return toWarehouse;
			}
	 ...
	 */
	public void setToWarehouse (ru.instefa.cafepickpos.model.InventoryWarehouse toWarehouse) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.InventoryTransaction)) return false;
		else {
			ru.instefa.cafepickpos.model.InventoryTransaction inventoryTransaction = (ru.instefa.cafepickpos.model.InventoryTransaction) obj;
