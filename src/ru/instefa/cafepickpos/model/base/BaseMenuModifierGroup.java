...
public abstract class BaseMenuModifierGroup  implements Comparable, Serializable {
	...
	// collections
	private java.util.Set<ru.instefa.cafepickpos.model.MenuModifier> modifiers;
	 ...
	 */
	public java.util.Set<ru.instefa.cafepickpos.model.MenuModifier> getModifiers () {
					return modifiers;
			}
	 ...
	 */
	public void setModifiers (java.util.Set<ru.instefa.cafepickpos.model.MenuModifier> modifiers) {
		this.modifiers = modifiers;
	}

	public void addTomodifiers (ru.instefa.cafepickpos.model.MenuModifier menuModifier) {
		if (null == getModifiers()) setModifiers(new java.util.TreeSet<ru.instefa.cafepickpos.model.MenuModifier>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.MenuModifierGroup)) return false;
		else {
			ru.instefa.cafepickpos.model.MenuModifierGroup menuModifierGroup = (ru.instefa.cafepickpos.model.MenuModifierGroup) obj;
