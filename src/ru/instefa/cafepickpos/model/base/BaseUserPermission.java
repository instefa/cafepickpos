...
public abstract class BaseUserPermission  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.UserPermission)) return false;
		else {
			ru.instefa.cafepickpos.model.UserPermission userPermission = (ru.instefa.cafepickpos.model.UserPermission) obj;
