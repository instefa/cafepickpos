...
public abstract class BaseKitchenTicket  implements Comparable, Serializable {
	...
	private java.util.List<ru.instefa.cafepickpos.model.KitchenTicketItem> ticketItems;
	 ...
	 */
	public java.util.List<ru.instefa.cafepickpos.model.KitchenTicketItem> getTicketItems () {
					return ticketItems;
			}
	 ...
	 */
	public void setTicketItems (java.util.List<ru.instefa.cafepickpos.model.KitchenTicketItem> ticketItems) {
		this.ticketItems = ticketItems;
	}

	public void addToticketItems (ru.instefa.cafepickpos.model.KitchenTicketItem kitchenTicketItem) {
		if (null == getTicketItems()) setTicketItems(new java.util.ArrayList<ru.instefa.cafepickpos.model.KitchenTicketItem>());
