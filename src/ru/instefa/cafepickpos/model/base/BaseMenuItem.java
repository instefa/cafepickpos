...
public abstract class BaseMenuItem  implements Comparable, Serializable {
	...
	// many to one
	private ru.instefa.cafepickpos.model.MenuGroup parent;
	private ru.instefa.cafepickpos.model.TaxGroup taxGroup;
	private ru.instefa.cafepickpos.model.Recepie recepie;
	private ru.instefa.cafepickpos.model.PrinterGroup printerGroup;

	// collections
	private java.util.List<ru.instefa.cafepickpos.model.PizzaPrice> pizzaPriceList;
	private java.util.List<ru.instefa.cafepickpos.model.MenuItemShift> shifts;
	private java.util.List<ru.instefa.cafepickpos.model.Discount> discounts;
	private java.util.List<ru.instefa.cafepickpos.model.MenuItemModifierGroup> menuItemModiferGroups;
	private java.util.List<ru.instefa.cafepickpos.model.Terminal> terminals;
	private java.util.Map<String,String> properties;
	private java.util.List<ru.instefa.cafepickpos.model.OrderType> orderTypeList;
	 ...
	 */
	public ru.instefa.cafepickpos.model.MenuGroup getParent () {
					return parent;
			}
	 ...
	 */
	public void setParent (ru.instefa.cafepickpos.model.MenuGroup parent) {
		this.parent = parent;
	}
	 ...
	 */
	public ru.instefa.cafepickpos.model.TaxGroup getTaxGroup () {
					return taxGroup;
			}
	 ...
	 */
	public void setTaxGroup (ru.instefa.cafepickpos.model.TaxGroup taxGroup) {
	 ...
	 */
	public ru.instefa.cafepickpos.model.Recepie getRecepie () {
					return recepie;
			}
	 ...
	 */
	public void setRecepie (ru.instefa.cafepickpos.model.Recepie recepie) {
	 ...
	 */
	public void setPrinterGroup (ru.instefa.cafepickpos.model.PrinterGroup printerGroup) {
	 ...
	 */
	public java.util.List<ru.instefa.cafepickpos.model.PizzaPrice> getPizzaPriceList () {
	 ...
	 */
	public void setPizzaPriceList (java.util.List<ru.instefa.cafepickpos.model.PizzaPrice> pizzaPriceList) {
		this.pizzaPriceList = pizzaPriceList;
	}

	public void addTopizzaPriceList (ru.instefa.cafepickpos.model.PizzaPrice pizzaPrice) {
		if (null == getPizzaPriceList()) setPizzaPriceList(new java.util.ArrayList<ru.instefa.cafepickpos.model.PizzaPrice>());
	 ...
	 */
	public java.util.List<ru.instefa.cafepickpos.model.MenuItemShift> getShifts () {
					return shifts;
			}
	 ...
	 */
	public void setShifts (java.util.List<ru.instefa.cafepickpos.model.MenuItemShift> shifts) {
		this.shifts = shifts;
	}

	public void addToshifts (ru.instefa.cafepickpos.model.MenuItemShift menuItemShift) {
		if (null == getShifts()) setShifts(new java.util.ArrayList<ru.instefa.cafepickpos.model.MenuItemShift>());
	 ...
	 */
	public java.util.List<ru.instefa.cafepickpos.model.Discount> getDiscounts () {
					return discounts;
			}
	 ...
	 */
	public void setDiscounts (java.util.List<ru.instefa.cafepickpos.model.Discount> discounts) {
		this.discounts = discounts;
	}

	public void addTodiscounts (ru.instefa.cafepickpos.model.Discount discount) {
		if (null == getDiscounts()) setDiscounts(new java.util.ArrayList<ru.instefa.cafepickpos.model.Discount>());
	 ...
	 */
	public java.util.List<ru.instefa.cafepickpos.model.MenuItemModifierGroup> getMenuItemModiferGroups () {
	 ...
	 */
	public void setMenuItemModiferGroups (java.util.List<ru.instefa.cafepickpos.model.MenuItemModifierGroup> menuItemModiferGroups) {
		this.menuItemModiferGroups = menuItemModiferGroups;
	}

	public void addTomenuItemModiferGroups (ru.instefa.cafepickpos.model.MenuItemModifierGroup menuItemModifierGroup) {
		if (null == getMenuItemModiferGroups()) setMenuItemModiferGroups(new java.util.ArrayList<ru.instefa.cafepickpos.model.MenuItemModifierGroup>());
	 ...
	 */
	public java.util.List<ru.instefa.cafepickpos.model.Terminal> getTerminals () {
					return terminals;
			}
	 ...
	 */
	public void setTerminals (java.util.List<ru.instefa.cafepickpos.model.Terminal> terminals) {
		this.terminals = terminals;
	}

	public void addToterminals (ru.instefa.cafepickpos.model.Terminal terminal) {
		if (null == getTerminals()) setTerminals(new java.util.ArrayList<ru.instefa.cafepickpos.model.Terminal>());
	 ...
	 */
	public java.util.List<ru.instefa.cafepickpos.model.OrderType> getOrderTypeList () {
	 ...
	 */
	public void setOrderTypeList (java.util.List<ru.instefa.cafepickpos.model.OrderType> orderTypeList) {
		this.orderTypeList = orderTypeList;
	}

	public void addToorderTypeList (ru.instefa.cafepickpos.model.OrderType orderType) {
		if (null == getOrderTypeList()) setOrderTypeList(new java.util.ArrayList<ru.instefa.cafepickpos.model.OrderType>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.MenuItem)) return false;
		else {
			ru.instefa.cafepickpos.model.MenuItem menuItem = (ru.instefa.cafepickpos.model.MenuItem) obj;
