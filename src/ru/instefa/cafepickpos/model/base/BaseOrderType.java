...
public abstract class BaseOrderType  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.OrderType)) return false;
		else {
			ru.instefa.cafepickpos.model.OrderType orderType = (ru.instefa.cafepickpos.model.OrderType) obj;
