...
public abstract class BasePizzaCrust  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.PizzaCrust)) return false;
		else {
			ru.instefa.cafepickpos.model.PizzaCrust pizzaCrust = (ru.instefa.cafepickpos.model.PizzaCrust) obj;
