...
public abstract class BaseUserType  implements Comparable, Serializable {
	...
	// collections
	private java.util.Set<ru.instefa.cafepickpos.model.UserPermission> permissions;
	 ...
	 */
	public java.util.Set<ru.instefa.cafepickpos.model.UserPermission> getPermissions () {
			return permissions;
	}
	 ...
	 */
	public void setPermissions (java.util.Set<ru.instefa.cafepickpos.model.UserPermission> permissions) {
		this.permissions = permissions;
	}

	public void addTopermissions (ru.instefa.cafepickpos.model.UserPermission userPermission) {
		if (null == getPermissions()) setPermissions(new java.util.TreeSet<ru.instefa.cafepickpos.model.UserPermission>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.UserType)) return false;
		else {
			ru.instefa.cafepickpos.model.UserType userType = (ru.instefa.cafepickpos.model.UserType) obj;
