...
public abstract class BaseGuestCheckPrint  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.GuestCheckPrint)) return false;
		else {
			ru.instefa.cafepickpos.model.GuestCheckPrint guestCheckPrint = (ru.instefa.cafepickpos.model.GuestCheckPrint) obj;
