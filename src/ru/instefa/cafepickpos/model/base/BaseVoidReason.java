...
public abstract class BaseVoidReason  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.VoidReason)) return false;
		else {
			ru.instefa.cafepickpos.model.VoidReason voidReason = (ru.instefa.cafepickpos.model.VoidReason) obj;
