...
public abstract class BaseMenuModifier implements Comparable, Serializable {
	...
	// many to one
	private ru.instefa.cafepickpos.model.MenuModifierGroup modifierGroup;
	private ru.instefa.cafepickpos.model.Tax tax;

	// collections
	private java.util.List<ru.instefa.cafepickpos.model.PizzaModifierPrice> pizzaModifierPriceList;
	 ...
	 */
	public ru.instefa.cafepickpos.model.MenuModifierGroup getModifierGroup() {
	 ...
	 */
	public void setModifierGroup(ru.instefa.cafepickpos.model.MenuModifierGroup modifierGroup) {
	 ...
	 */
	public ru.instefa.cafepickpos.model.Tax getTax() {
		return tax;
	}
	 ...
	 */
	public void setTax(ru.instefa.cafepickpos.model.Tax tax) {
		this.tax = tax;
	}
	 ...
	 */
	public java.util.List<ru.instefa.cafepickpos.model.PizzaModifierPrice> getPizzaModifierPriceList() {
	 ...
	 */
	public void setPizzaModifierPriceList(java.util.List<ru.instefa.cafepickpos.model.PizzaModifierPrice> pizzaModifierPriceList) {
		this.pizzaModifierPriceList = pizzaModifierPriceList;
	}

	public void addTopizzaModifierPriceList(ru.instefa.cafepickpos.model.PizzaModifierPrice pizzaModifierPrice) {
		if (null == getPizzaModifierPriceList())
			setPizzaModifierPriceList(new java.util.ArrayList<ru.instefa.cafepickpos.model.PizzaModifierPrice>());
	...
	public void addTomultiplierPriceList(ru.instefa.cafepickpos.model.ModifierMultiplierPrice modifierMultiplierPrice) {
		if (null == getMultiplierPriceList())
			setMultiplierPriceList(new java.util.ArrayList<ru.instefa.cafepickpos.model.ModifierMultiplierPrice>());
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof ru.instefa.cafepickpos.model.MenuModifier))
			return false;
		else {
			ru.instefa.cafepickpos.model.MenuModifier menuModifier = (ru.instefa.cafepickpos.model.MenuModifier) obj;
