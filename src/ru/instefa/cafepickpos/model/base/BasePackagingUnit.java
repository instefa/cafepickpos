...
public abstract class BasePackagingUnit  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.PackagingUnit)) return false;
		else {
			ru.instefa.cafepickpos.model.PackagingUnit packagingUnit = (ru.instefa.cafepickpos.model.PackagingUnit) obj;
