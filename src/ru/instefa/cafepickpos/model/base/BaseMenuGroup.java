...
public abstract class BaseMenuGroup  implements Comparable, Serializable {
	...
	// many to one
	private ru.instefa.cafepickpos.model.MenuCategory parent;
	 ...
	 */
	public ru.instefa.cafepickpos.model.MenuCategory getParent () {
					return parent;
			}
	 ...
	 */
	public void setParent (ru.instefa.cafepickpos.model.MenuCategory parent) {
		this.parent = parent;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.MenuGroup)) return false;
		else {
			ru.instefa.cafepickpos.model.MenuGroup menuGroup = (ru.instefa.cafepickpos.model.MenuGroup) obj;
