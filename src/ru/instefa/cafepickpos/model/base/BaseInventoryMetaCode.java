...
public abstract class BaseInventoryMetaCode  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.InventoryMetaCode)) return false;
		else {
			ru.instefa.cafepickpos.model.InventoryMetaCode inventoryMetaCode = (ru.instefa.cafepickpos.model.InventoryMetaCode) obj;
