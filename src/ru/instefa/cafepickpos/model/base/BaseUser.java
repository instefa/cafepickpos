...
public abstract class BaseUser  implements Comparable, Serializable {
	...
	// many to one
	private ru.instefa.cafepickpos.model.Shift currentShift;
	private ru.instefa.cafepickpos.model.Terminal currentTerminal;
	private ru.instefa.cafepickpos.model.UserType type;
	 ...
	 */
	public ru.instefa.cafepickpos.model.Shift getCurrentShift () {
					return currentShift;
			}
	 ...
	 */
	public void setCurrentShift (ru.instefa.cafepickpos.model.Shift currentShift) {
	 ...
	 */
	public ru.instefa.cafepickpos.model.Terminal getCurrentTerminal () {
	 ...
	 */
	public void setCurrentTerminal (ru.instefa.cafepickpos.model.Terminal currentTerminal) {
	 ...
	 */
	public ru.instefa.cafepickpos.model.UserType getType () {
					return type;
			}
	 ...
	 */
	public void setType (ru.instefa.cafepickpos.model.UserType type) {
		this.type = type;
	}
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.User)) return false;
		else {
			ru.instefa.cafepickpos.model.User user = (ru.instefa.cafepickpos.model.User) obj;
