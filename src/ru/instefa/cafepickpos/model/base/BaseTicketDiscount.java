...
public abstract class BaseTicketDiscount  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.TicketDiscount)) return false;
		else {
			ru.instefa.cafepickpos.model.TicketDiscount ticketDiscount = (ru.instefa.cafepickpos.model.TicketDiscount) obj;
