...
public abstract class BaseActionHistory  implements Comparable, Serializable {
	...
	// many to one
	private ru.instefa.cafepickpos.model.User performer;
	 ...
	 */
	public ru.instefa.cafepickpos.model.User getPerformer () {
			return performer;
	}
	 ...
	 */
	public void setPerformer (ru.instefa.cafepickpos.model.User performer) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.ActionHistory)) return false;
		else {
			ru.instefa.cafepickpos.model.ActionHistory actionHistory = (ru.instefa.cafepickpos.model.ActionHistory) obj;
