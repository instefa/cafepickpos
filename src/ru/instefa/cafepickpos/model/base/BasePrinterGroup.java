...
public abstract class BasePrinterGroup  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.PrinterGroup)) return false;
		else {
			ru.instefa.cafepickpos.model.PrinterGroup printerGroup = (ru.instefa.cafepickpos.model.PrinterGroup) obj;
