...
public abstract class BaseMultiplier  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.Multiplier)) return false;
		else {
			ru.instefa.cafepickpos.model.Multiplier multiplier = (ru.instefa.cafepickpos.model.Multiplier) obj;
