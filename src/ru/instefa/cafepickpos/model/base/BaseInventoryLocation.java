...
public abstract class BaseInventoryLocation  implements Comparable, Serializable {
	...
	// many to one
	private ru.instefa.cafepickpos.model.InventoryWarehouse warehouse;
	 ...
	 */
	public ru.instefa.cafepickpos.model.InventoryWarehouse getWarehouse () {
					return warehouse;
			}
	 ...
	 */
	public void setWarehouse (ru.instefa.cafepickpos.model.InventoryWarehouse warehouse) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.InventoryLocation)) return false;
		else {
			ru.instefa.cafepickpos.model.InventoryLocation inventoryLocation = (ru.instefa.cafepickpos.model.InventoryLocation) obj;
