...
public abstract class BaseVirtualPrinter  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.VirtualPrinter)) return false;
		else {
			ru.instefa.cafepickpos.model.VirtualPrinter virtualPrinter = (ru.instefa.cafepickpos.model.VirtualPrinter) obj;
