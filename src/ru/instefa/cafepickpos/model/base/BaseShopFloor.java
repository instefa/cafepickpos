...
public abstract class BaseShopFloor  implements Comparable, Serializable {
	...
	// collections
	private java.util.Set<ru.instefa.cafepickpos.model.ShopTable> tables;
	 ...
	 */
	public java.util.Set<ru.instefa.cafepickpos.model.ShopTable> getTables () {
					return tables;
			}
	 ...
	 */
	public void setTables (java.util.Set<ru.instefa.cafepickpos.model.ShopTable> tables) {
		this.tables = tables;
	}

	public void addTotables (ru.instefa.cafepickpos.model.ShopTable shopTable) {
		if (null == getTables()) setTables(new java.util.TreeSet<ru.instefa.cafepickpos.model.ShopTable>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.ShopFloor)) return false;
		else {
			ru.instefa.cafepickpos.model.ShopFloor shopFloor = (ru.instefa.cafepickpos.model.ShopFloor) obj;
