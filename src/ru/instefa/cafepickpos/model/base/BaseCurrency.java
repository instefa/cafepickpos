...
public abstract class BaseCurrency  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.Currency)) return false;
		else {
			ru.instefa.cafepickpos.model.Currency currency = (ru.instefa.cafepickpos.model.Currency) obj;
