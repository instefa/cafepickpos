...
public abstract class BaseDrawerPullReport  implements Comparable, Serializable {
	...
	private java.util.Set<ru.instefa.cafepickpos.model.CurrencyBalance> currencyBalances;
	 ...
	 */
	public java.util.Set<ru.instefa.cafepickpos.model.CurrencyBalance> getCurrencyBalances () {
	 ...
	 */
	public void setCurrencyBalances (java.util.Set<ru.instefa.cafepickpos.model.CurrencyBalance> currencyBalances) {
		this.currencyBalances = currencyBalances;
	}

	public void addTocurrencyBalances (ru.instefa.cafepickpos.model.CurrencyBalance currencyBalance) {
		if (null == getCurrencyBalances()) setCurrencyBalances(new java.util.TreeSet<ru.instefa.cafepickpos.model.CurrencyBalance>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.DrawerPullReport)) return false;
		else {
			ru.instefa.cafepickpos.model.DrawerPullReport drawerPullReport = (ru.instefa.cafepickpos.model.DrawerPullReport) obj;
