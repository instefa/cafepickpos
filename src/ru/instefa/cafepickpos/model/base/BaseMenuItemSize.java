...
public abstract class BaseMenuItemSize  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.MenuItemSize)) return false;
		else {
			ru.instefa.cafepickpos.model.MenuItemSize menuItemSize = (ru.instefa.cafepickpos.model.MenuItemSize) obj;
