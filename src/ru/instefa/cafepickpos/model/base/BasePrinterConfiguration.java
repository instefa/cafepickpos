...
public abstract class BasePrinterConfiguration  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.PrinterConfiguration)) return false;
		else {
			ru.instefa.cafepickpos.model.PrinterConfiguration printerConfiguration = (ru.instefa.cafepickpos.model.PrinterConfiguration) obj;
