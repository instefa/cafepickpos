...
public abstract class BaseDeliveryAddress  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.DeliveryAddress)) return false;
		else {
			ru.instefa.cafepickpos.model.DeliveryAddress deliveryAddress = (ru.instefa.cafepickpos.model.DeliveryAddress) obj;
