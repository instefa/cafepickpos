...
public abstract class BasePayoutReason  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.PayoutReason)) return false;
		else {
			ru.instefa.cafepickpos.model.PayoutReason payoutReason = (ru.instefa.cafepickpos.model.PayoutReason) obj;
