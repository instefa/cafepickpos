...
public abstract class BaseTicketItemDiscount implements Comparable, Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof ru.instefa.cafepickpos.model.TicketItemDiscount))
			return false;
		else {
			ru.instefa.cafepickpos.model.TicketItemDiscount ticketItemDiscount = (ru.instefa.cafepickpos.model.TicketItemDiscount) obj;
