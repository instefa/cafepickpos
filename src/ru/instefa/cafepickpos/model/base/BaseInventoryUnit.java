...
public abstract class BaseInventoryUnit  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.InventoryUnit)) return false;
		else {
			ru.instefa.cafepickpos.model.InventoryUnit inventoryUnit = (ru.instefa.cafepickpos.model.InventoryUnit) obj;
