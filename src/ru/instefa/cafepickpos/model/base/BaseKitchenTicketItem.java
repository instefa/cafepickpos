...
public abstract class BaseKitchenTicketItem  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.KitchenTicketItem)) return false;
		else {
			ru.instefa.cafepickpos.model.KitchenTicketItem kitchenTicketItem = (ru.instefa.cafepickpos.model.KitchenTicketItem) obj;
