...
public abstract class BaseRestaurant  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.Restaurant)) return false;
		else {
			ru.instefa.cafepickpos.model.Restaurant restaurant = (ru.instefa.cafepickpos.model.Restaurant) obj;
