...
public abstract class BaseTicket  implements Comparable, Serializable {
	...
	// many to one
	private ru.instefa.cafepickpos.model.Shift shift;
	private ru.instefa.cafepickpos.model.User owner;
	private ru.instefa.cafepickpos.model.User assignedDriver;
	private ru.instefa.cafepickpos.model.Gratuity gratuity;
	private ru.instefa.cafepickpos.model.User voidedBy;
	private ru.instefa.cafepickpos.model.Terminal terminal;

	// collections
	private java.util.Map<String, String> properties;
	private java.util.List<ru.instefa.cafepickpos.model.TicketItem> ticketItems;
	private java.util.List<ru.instefa.cafepickpos.model.TicketDiscount> discounts;
	private java.util.Set<ru.instefa.cafepickpos.model.PosTransaction> transactions;
	 ...
	 */
	public ru.instefa.cafepickpos.model.Shift getShift () {
					return shift;
			}
	 ...
	 */
	public void setShift (ru.instefa.cafepickpos.model.Shift shift) {
		this.shift = shift;
	}
	 ...
	 */
	public ru.instefa.cafepickpos.model.User getAssignedDriver () {
	 ...
	 */
	public void setAssignedDriver (ru.instefa.cafepickpos.model.User assignedDriver) {
	 ...
	 */
	public ru.instefa.cafepickpos.model.Gratuity getGratuity () {
					return gratuity;
			}
	 ...
	 */
	public void setGratuity (ru.instefa.cafepickpos.model.Gratuity gratuity) {
	 ...
	 */
	public ru.instefa.cafepickpos.model.User getVoidedBy () {
					return voidedBy;
			}
	 ...
	 */
	public void setVoidedBy (ru.instefa.cafepickpos.model.User voidedBy) {
	 ...
	 */
	public java.util.List<ru.instefa.cafepickpos.model.TicketItem> getTicketItems () {
					return ticketItems;
			}
	 ...
	 */
	public void setTicketItems (java.util.List<ru.instefa.cafepickpos.model.TicketItem> ticketItems) {
		this.ticketItems = ticketItems;
	}

	public void addToticketItems (ru.instefa.cafepickpos.model.TicketItem ticketItem) {
		if (null == getTicketItems()) setTicketItems(new java.util.ArrayList<ru.instefa.cafepickpos.model.TicketItem>());
	 ...
	 */
	public java.util.List<ru.instefa.cafepickpos.model.TicketDiscount> getDiscounts () {
					return discounts;
			}
	 ...
	 */
	public void setDiscounts (java.util.List<ru.instefa.cafepickpos.model.TicketDiscount> discounts) {
		this.discounts = discounts;
	}

	public void addTodiscounts (ru.instefa.cafepickpos.model.TicketDiscount ticketDiscount) {
		if (null == getDiscounts()) setDiscounts(new java.util.ArrayList<ru.instefa.cafepickpos.model.TicketDiscount>());
	 ...
	 */
	public java.util.Set<ru.instefa.cafepickpos.model.PosTransaction> getTransactions () {
					return transactions;
			}
	 ...
	 */
	public void setTransactions (java.util.Set<ru.instefa.cafepickpos.model.PosTransaction> transactions) {
		this.transactions = transactions;
	}

	public void addTotransactions (ru.instefa.cafepickpos.model.PosTransaction posTransaction) {
		if (null == getTransactions()) setTransactions(new java.util.TreeSet<ru.instefa.cafepickpos.model.PosTransaction>());
