...
public abstract class BaseAttendenceHistory  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.AttendenceHistory)) return false;
		else {
			ru.instefa.cafepickpos.model.AttendenceHistory attendenceHistory = (ru.instefa.cafepickpos.model.AttendenceHistory) obj;
