...
public abstract class BasePosTransaction  implements Comparable, Serializable {
	...
	private ru.instefa.cafepickpos.model.PayoutReason reason;
	private ru.instefa.cafepickpos.model.PayoutRecepient recepient;
	 ...
	 */
	public ru.instefa.cafepickpos.model.PayoutReason getReason () {
					return reason;
			}
	 ...
	 */
	public void setReason (ru.instefa.cafepickpos.model.PayoutReason reason) {
		this.reason = reason;
	}
	 ...
	 */
	public ru.instefa.cafepickpos.model.PayoutRecepient getRecepient () {
					return recepient;
			}
	 ...
	 */
	public void setRecepient (ru.instefa.cafepickpos.model.PayoutRecepient recepient) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.PosTransaction)) return false;
		else {
			ru.instefa.cafepickpos.model.PosTransaction posTransaction = (ru.instefa.cafepickpos.model.PosTransaction) obj;
