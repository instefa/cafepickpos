...
public abstract class BaseTicketItem  implements Comparable, Serializable {
	...
	// many to one
	private ru.instefa.cafepickpos.model.TicketItemModifier sizeModifier;
	private ru.instefa.cafepickpos.model.Ticket ticket;
	private ru.instefa.cafepickpos.model.PrinterGroup printerGroup;

	// collections
	private java.util.List<ru.instefa.cafepickpos.model.TicketItemModifier> ticketItemModifiers;
	private java.util.List<ru.instefa.cafepickpos.model.TicketItemModifier> addOns;
	private java.util.List<ru.instefa.cafepickpos.model.TicketItemDiscount> discounts;
	 ...
	 */
	public ru.instefa.cafepickpos.model.TicketItemModifier getSizeModifier () {
					return sizeModifier;
			}
	 ...
	 */
	public void setSizeModifier (ru.instefa.cafepickpos.model.TicketItemModifier sizeModifier) {
	 ...
	 */
	public java.util.List<ru.instefa.cafepickpos.model.TicketItemModifier> getTicketItemModifiers () {
	 ...
	 */
	public void setTicketItemModifiers (java.util.List<ru.instefa.cafepickpos.model.TicketItemModifier> ticketItemModifiers) {
		this.ticketItemModifiers = ticketItemModifiers;
	}

	public void addToticketItemModifiers (ru.instefa.cafepickpos.model.TicketItemModifier ticketItemModifier) {
		if (null == getTicketItemModifiers()) setTicketItemModifiers(new java.util.ArrayList<ru.instefa.cafepickpos.model.TicketItemModifier>());
	 ...
	 */
	public java.util.List<ru.instefa.cafepickpos.model.TicketItemModifier> getAddOns () {
					return addOns;
			}
	 ...
	 */
	public void setAddOns (java.util.List<ru.instefa.cafepickpos.model.TicketItemModifier> addOns) {
		this.addOns = addOns;
	}

	public void addToaddOns (ru.instefa.cafepickpos.model.TicketItemModifier ticketItemModifier) {
		if (null == getAddOns()) setAddOns(new java.util.ArrayList<ru.instefa.cafepickpos.model.TicketItemModifier>());
	 ...
	 */
	public void setDiscounts (java.util.List<ru.instefa.cafepickpos.model.TicketItemDiscount> discounts) {
		this.discounts = discounts;
	}

	public void addTodiscounts (ru.instefa.cafepickpos.model.TicketItemDiscount ticketItemDiscount) {
		if (null == getDiscounts()) setDiscounts(new java.util.ArrayList<ru.instefa.cafepickpos.model.TicketItemDiscount>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.TicketItem)) return false;
		else {
			ru.instefa.cafepickpos.model.TicketItem ticketItem = (ru.instefa.cafepickpos.model.TicketItem) obj;
