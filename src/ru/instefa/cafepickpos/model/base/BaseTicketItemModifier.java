...
public abstract class BaseTicketItemModifier  implements Comparable, Serializable {
	...
	// many to one
	private ru.instefa.cafepickpos.model.TicketItem ticketItem;
	 ...
	 */
	public ru.instefa.cafepickpos.model.TicketItem getTicketItem () {
					return ticketItem;
			}
	 ...
	 */
	public void setTicketItem (ru.instefa.cafepickpos.model.TicketItem ticketItem) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.TicketItemModifier)) return false;
		else {
			ru.instefa.cafepickpos.model.TicketItemModifier ticketItemModifier = (ru.instefa.cafepickpos.model.TicketItemModifier) obj;
