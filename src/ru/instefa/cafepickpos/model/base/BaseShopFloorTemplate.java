...
public abstract class BaseShopFloorTemplate  implements Comparable, Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.ShopFloorTemplate)) return false;
		else {
			ru.instefa.cafepickpos.model.ShopFloorTemplate shopFloorTemplate = (ru.instefa.cafepickpos.model.ShopFloorTemplate) obj;
