...
public abstract class BaseCustomPayment implements Comparable, Serializable {
	...
	public boolean equals(Object obj) {
		if (null == obj)
			return false;
		if (!(obj instanceof ru.instefa.cafepickpos.model.CustomPayment))
			return false;
		else {
			ru.instefa.cafepickpos.model.CustomPayment customPayment = (ru.instefa.cafepickpos.model.CustomPayment) obj;
