...
public abstract class BaseDiscount  implements Comparable, Serializable {
	...
	// collections
	private java.util.List<ru.instefa.cafepickpos.model.MenuItem> menuItems;
	private java.util.List<ru.instefa.cafepickpos.model.MenuGroup> menuGroups;
	private java.util.List<ru.instefa.cafepickpos.model.MenuCategory> menuCategories;
	 ...
	 */
	public java.util.List<ru.instefa.cafepickpos.model.MenuItem> getMenuItems () {
					return menuItems;
			}
	 ...
	 */
	public void setMenuItems (java.util.List<ru.instefa.cafepickpos.model.MenuItem> menuItems) {
		this.menuItems = menuItems;
	}

	public void addTomenuItems (ru.instefa.cafepickpos.model.MenuItem menuItem) {
		if (null == getMenuItems()) setMenuItems(new java.util.ArrayList<ru.instefa.cafepickpos.model.MenuItem>());
	 ...
	 */
	public java.util.List<ru.instefa.cafepickpos.model.MenuGroup> getMenuGroups () {
					return menuGroups;
			}
	 ...
	 */
	public void setMenuGroups (java.util.List<ru.instefa.cafepickpos.model.MenuGroup> menuGroups) {
		this.menuGroups = menuGroups;
	}

	public void addTomenuGroups (ru.instefa.cafepickpos.model.MenuGroup menuGroup) {
		if (null == getMenuGroups()) setMenuGroups(new java.util.ArrayList<ru.instefa.cafepickpos.model.MenuGroup>());
	 ...
	 */
	public java.util.List<ru.instefa.cafepickpos.model.MenuCategory> getMenuCategories () {
	 ...
	 */
	public void setMenuCategories (java.util.List<ru.instefa.cafepickpos.model.MenuCategory> menuCategories) {
		this.menuCategories = menuCategories;
	}

	public void addTomenuCategories (ru.instefa.cafepickpos.model.MenuCategory menuCategory) {
		if (null == getMenuCategories()) setMenuCategories(new java.util.ArrayList<ru.instefa.cafepickpos.model.MenuCategory>());
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof ru.instefa.cafepickpos.model.Discount)) return false;
		else {
			ru.instefa.cafepickpos.model.Discount discount = (ru.instefa.cafepickpos.model.Discount) obj;
