...
import ru.instefa.cafepickpos.model.base.BaseVirtualPrinter;
...
public class VirtualPrinter extends BaseVirtualPrinter {
	...
	public final static String[] PRINTER_TYPE_NAMES = { 
		Messages.getString("VirtualPrinter.0"),
		Messages.getString("VirtualPrinter.1"),
		Messages.getString("VirtualPrinter.2"),
		Messages.getString("VirtualPrinter.3"),
		Messages.getString("VirtualPrinter.4")
