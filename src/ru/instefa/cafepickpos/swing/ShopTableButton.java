...
public class ShopTableButton extends PosButton {
	...
	public void update() {
		...
		if (StringUtils.isNotEmpty(ticketIdAsString) && ticketCreateTime == null) {
			ticketIdAsString = "<br>" + Messages.getString("TableSelectionView.4") + ticketIdAsString;
	...
	public boolean hasUserAccess() {
		...
		if (inputUserId != user.getAutoId()) {
			POSMessageDialog.showError(Application.getPosWindow(), Messages.getString("ShopTableButton.0")); //$NON-NLS-1$
			return false;
		}
		return true;
	}
