...
import ru.instefa.cafepickpos.exceptions.PosRuntimeException;
...
public class MenuItemModifierGroupForm extends BeanEditor {
	...
	public MenuItemModifierGroupForm(MenuItemModifierGroup modifierGroup) {
		...
		try {
			...
			throw new PosRuntimeException(ru.instefa.cafepickpos.POSConstants.ERROR_MESSAGE);
		}
	...
	private void initComponents() {
		...
		jLabel1.setText(ru.instefa.cafepickpos.POSConstants.MODIFIER_GROUP + ":"); //$NON-NLS-1$

		jLabel2.setText(ru.instefa.cafepickpos.POSConstants.MIN_QUANTITY + ":"); //$NON-NLS-1$

		jLabel3.setText(ru.instefa.cafepickpos.POSConstants.MAX_QUANTITY + ":"); //$NON-NLS-1$
	...
	protected boolean updateModel() {
		...
		if (group == null) {
			POSMessageDialog.showError(this, ru.instefa.cafepickpos.POSConstants.MODIFIER_GROUP_REQUIRED);
			return false;
		}
		MenuItemModifierGroup modifierGroup = (MenuItemModifierGroup) getBean();
	...
	public String getDisplayText() {
		...
		if (modifierGroup.getId() == null) {
			return ru.instefa.cafepickpos.POSConstants.ADD_NEW_MODIFIER_GROUP_IN_MENU_ITEM_;
		}

		return ru.instefa.cafepickpos.POSConstants.EDIT_MODIFIER_GROUP_IN_MENU_ITEM_;
	}
