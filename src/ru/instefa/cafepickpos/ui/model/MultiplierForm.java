...
public class MultiplierForm extends BeanEditor {
	...
	private void initComponents() {
		...
		tfTicketPrefix = new ru.instefa.cafepickpos.swing.FixedLengthTextField();
		...
		contentPanel.add(new javax.swing.JLabel(Messages.getString("MultiplierForm.1")));
		contentPanel.add(tfTicketPrefix, "grow,wrap");

		contentPanel.add(new javax.swing.JLabel(Messages.getString("MultiplierForm.2")));
	...
	public String getDisplayText() {
		...
		if (multiplier.getName() == null) {
			return Messages.getString("MultiplierForm.4");
		}
		return Messages.getString("MultiplierForm.5");
	}
}
