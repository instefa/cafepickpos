...
public class MenuModifierForm extends BeanEditor {
	...
	private void initComponents() {
		...
		JLabel lblExtraPrice = new javax.swing.JLabel(ru.instefa.cafepickpos.POSConstants.EXTRA_PRICE + ":");
		...
		jTabbedPane1.addTab(Messages.getString("MenuItemForm.26"), tabButtonStyle); //$NON-NLS-1$

		btnButtonColor.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				Color color = JColorChooser.showDialog(MenuModifierForm.this, Messages.getString("MenuModifierForm.39"),
						btnButtonColor.getBackground()); //$NON-NLS-1$
		...
		btnTextColor.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				Color color = JColorChooser.showDialog(MenuModifierForm.this, Messages.getString("MenuModifierForm.40"),
						btnTextColor.getForeground()); //$NON-NLS-1$
		...
		scrollPane.setBorder(new TitledBorder(Messages.getString("MenuModifierForm.50")));
