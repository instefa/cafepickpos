...
import ru.instefa.cafepickpos.swing.CheckBoxList.CheckBoxListModel;
import ru.instefa.cafepickpos.swing.CheckBoxList.Entry;
...
public class UserTypeForm extends BeanEditor {
	...
	private void initComponents() {
		...
		jLabel1.setText(ru.instefa.cafepickpos.POSConstants.TYPE_NAME + ":"); //$NON-NLS-1$
		jLabel2.setText(ru.instefa.cafepickpos.POSConstants.PERMISSIONS + ":"); //$NON-NLS-1$
	...
	public String getDisplayText() {
		if (userType == null)
			return Messages.getString("UserTypeForm.0"); //$NON-NLS-1$

		return Messages.getString("UserTypeForm.1"); //$NON-NLS-1$
	}
	...
	protected boolean updateModel() throws IllegalModelStateException {
		...
		if (StringUtils.isEmpty(name)) {
			throw new IllegalModelStateException(ru.instefa.cafepickpos.POSConstants.TYPE_NAME_CANNOT_BE_EMPTY);
		}
