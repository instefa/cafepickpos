...
public class CouponAndDiscountDialog extends POSDialog implements ActionListener, ListSelectionListener {
	...
	private void initComponents() {
		...
		btnOk.setIcon(IconFactory.getIcon("finish.png")); // NOI18N //$NON-NLS-1$ //$NON-NLS-2$
		...
		btnUp.setIcon(IconFactory.getIcon("up.png")); // NOI18N //$NON-NLS-1$ //$NON-NLS-2$

		btnDown.setIcon(IconFactory.getIcon("down.png")); // NOI18N //$NON-NLS-1$ //$NON-NLS-2$
