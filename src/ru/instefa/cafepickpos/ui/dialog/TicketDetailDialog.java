...
public class TicketDetailDialog extends POSDialog {
    ...
    private void initComponents() {
        ...
        setTitle(ru.instefa.cafepickpos.POSConstants.TICKET_DETAIL);

        titlePanel1.setTitle(ru.instefa.cafepickpos.POSConstants.TICKET_DETAIL);

        btnFinish.setText(ru.instefa.cafepickpos.POSConstants.OK);
