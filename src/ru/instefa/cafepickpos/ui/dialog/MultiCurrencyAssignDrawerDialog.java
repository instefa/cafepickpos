...
public class MultiCurrencyAssignDrawerDialog extends OkCancelOptionDialog {
	...
	private void init() {
		...
		setTitlePaneText(Messages.getString("MultiCurrencyAssignDrawerDialog.0"));
		setResizable(false);
		...
		JLabel lblCurrency = getJLabel(Messages.getString("MultiCurrencyAssignDrawerDialog.1"),
            Font.BOLD, 16, JLabel.CENTER);
		JLabel lblAmount = getJLabel(Messages.getString("MultiCurrencyAssignDrawerDialog.2"),
            Font.BOLD, 16, JLabel.CENTER);
