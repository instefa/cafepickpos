...
public class GuestChkBillDialog extends POSDialog {
	...
	private void initComponents() {
		...
		titlePanel.setTitle(Messages.getString("GuestChkBillDialog.0"));

		JTable table = new JTable();
		tableModel = new BeanTableModel<GuestCheckPrint>(GuestCheckPrint.class);
		tableModel.addColumn(POSConstants.TICKET_ID, "ticketId");
		tableModel.addColumn(Messages.getString("GuestChkBillDialog.1"), "tableNo");
		tableModel.addColumn(Messages.getString("GuestChkBillDialog.2"), "user");
		tableModel.addColumn(Messages.getString("GuestChkBillDialog.3"), "printTime");
		tableModel.addColumn(Messages.getString("GuestChkBillDialog.4"), "diffInBillPrint");
	...
	private void initData() {
		...
		tableModel.setRows(guestCheckPrints);
	}
