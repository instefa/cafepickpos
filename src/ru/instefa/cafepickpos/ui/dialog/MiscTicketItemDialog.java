...
public class MiscTicketItemDialog extends OkCancelOptionDialog {
	...
	public void doOk() {
		...
		ticketItem.setCategoryName(ru.instefa.cafepickpos.POSConstants.MISC_BUTTON_TEXT);
		ticketItem.setGroupName(ru.instefa.cafepickpos.POSConstants.MISC_BUTTON_TEXT);
