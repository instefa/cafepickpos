...
public class SelectCookingInstructionDialog extends POSDialog implements ActionListener {
	...
	protected void initUI() {
		...
		btnNew = new PosButton(ru.instefa.cafepickpos.POSConstants.NEW);
		btnOk = new PosButton(ru.instefa.cafepickpos.POSConstants.OK);
		btnCancel = new PosButton(ru.instefa.cafepickpos.POSConstants.CANCEL);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(ru.instefa.cafepickpos.POSConstants.OK.equalsIgnoreCase(actionCommand)) {
			doOk();
		}
		else if(ru.instefa.cafepickpos.POSConstants.CANCEL.equalsIgnoreCase(actionCommand)) {
			doCancel();
		}
		else if(ru.instefa.cafepickpos.POSConstants.NEW.equalsIgnoreCase(actionCommand)) {
			doCreateNew();
		}
	}
