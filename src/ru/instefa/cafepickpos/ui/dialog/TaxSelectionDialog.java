...
import ru.instefa.cafepickpos.bo.ui.explorer.ExplorerButtonPanel;
...
public class TaxSelectionDialog extends POSDialog {
	...
	private void init() {
		...
		setTitle(Messages.getString("TaxSelectionDialog.0"));
		TitlePanel titelpanel = new TitlePanel();
		titelpanel.setTitle(Messages.getString("TaxSelectionDialog.1") + " " + taxGroup.getName());
		...
		tableModel.addColumn(POSConstants.RATE.toUpperCase(), "rate"); //$NON-NLS-1$
	...
	private TransparentPanel createButtonPanel() {
		...
		JButton btnOk = new JButton(POSConstants.SAVE_BUTTON_TEXT);
		...
		btnAdd.setText(Messages.getString("TaxSelectionDialog.2"));
