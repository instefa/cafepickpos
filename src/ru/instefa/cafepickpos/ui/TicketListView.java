...
import ru.instefa.cafepickpos.model.dao.DataUpdateInfoDAO;
...
import ru.instefa.cafepickpos.swing.PosBlinkButton;
...
public class TicketListView extends JPanel implements ITicketList {
	...
	private void createScrollPane() {
		...
		if (!isCustomerHistoryOpen) {
			btnOrderFilters = new POSToggleButton(PosGuiUtil.getCenteredMultilineHtml(Messages.getString("SwitchboardView.2")));
		}
		...
		PosScrollPane scrollPane = new PosScrollPane(table, PosScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED,
	...
	private class TicketListTableModel extends PaginatedTableModel {
		public TicketListTableModel() {
			super(new String[] { POSConstants.TICKET_LIST_COLUMN_ID,
					POSConstants.TICKET_LIST_COLUMN_TABLE, POSConstants.TICKET_LIST_COLUMN_SERVER,
					POSConstants.TICKET_LIST_COLUMN_CREATE_DATE,
					POSConstants.TICKET_LIST_COLUMN_CUSTOMER, POSConstants.TICKET_LIST_COLUMN_DELIVERY_ADDRESS,
					POSConstants.TICKET_LIST_COLUMN_DELIVERY_DATE,
