...
import ru.instefa.cafepickpos.ui.views.CustomerView;
...
public class RootView extends ru.instefa.cafepickpos.swing.TransparentPanel {
	private CardLayout cards = new CardLayout();

	private HeaderPanel headerPanel = HeaderPanel.getInstance();
	...
	public void showDefaultView() {
        ...
        else if (defaultViewName.equals(BookingView.VIEW_NAME)) {
			if (!hasView(BookingView.getInstance())) {
				addView(BookingView.getInstance());
			}

			headerPanel.setVisible(false);
			setAndShowHomeScreen(BookingView.getInstance());
		}
		else {
