...
public class ModifierSelectionDialog extends POSDialog implements ModifierGroupSelectionListener, ModifierSelectionListener {
	...
	private ru.instefa.cafepickpos.swing.TransparentPanel buttonPanel;

	private ru.instefa.cafepickpos.swing.PosButton btnSave;
	...
	private void initComponents() {
		...
		modifierGroupView = new ru.instefa.cafepickpos.ui.views.order.modifier.ModifierGroupView(modifierSelectionModel);
		...
		buttonPanel = new ru.instefa.cafepickpos.swing.TransparentPanel();
	...
	public ru.instefa.cafepickpos.ui.views.order.modifier.ModifierGroupView getModifierGroupView() {
		return modifierGroupView;
	}

	public void setModifierGroupView(ru.instefa.cafepickpos.ui.views.order.modifier.ModifierGroupView modifierGroupView) {
