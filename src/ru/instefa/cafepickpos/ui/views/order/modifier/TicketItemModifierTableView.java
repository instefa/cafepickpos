...
package ru.instefa.cafepickpos.ui.views.order.modifier;
...
import ru.instefa.cafepickpos.ui.views.order.actions.OrderListener;
...
public class TicketItemModifierTableView extends JPanel {
	...
	private ru.instefa.cafepickpos.swing.TransparentPanel ticketActionPanel = new ru.instefa.cafepickpos.swing.TransparentPanel();

	//private ru.instefa.cafepickpos.swing.PosButton btnDecreaseAmount;
	private ru.instefa.cafepickpos.swing.PosButton btnDelete = new PosButton(IconFactory.getIcon("delete.png")); //$NON-NLS-1$ //$NON-NLS-2$	
	//private ru.instefa.cafepickpos.swing.PosButton btnIncreaseAmount = new PosButton(IconFactory.getIcon("add_user.png")); //$NON-NLS-1$ //$NON-NLS-2$
	private ru.instefa.cafepickpos.swing.PosButton btnScrollDown;
	private ru.instefa.cafepickpos.swing.PosButton btnScrollUp = new PosButton(IconFactory.getIcon("up.png")); //$NON-NLS-1$ //$NON-NLS-2$

	private ru.instefa.cafepickpos.swing.TransparentPanel ticketItemActionPanel;

	private javax.swing.JScrollPane ticketScrollPane;
	private ru.instefa.cafepickpos.ui.views.order.modifier.ModifierViewerTable modifierViewerTable;
	...
	private void initComponents() {
		...
		ticketItemActionPanel = new ru.instefa.cafepickpos.swing.TransparentPanel();
		//btnDecreaseAmount = new ru.instefa.cafepickpos.swing.PosButton();
		btnScrollDown = new ru.instefa.cafepickpos.swing.PosButton();
		modifierViewerTable = new ru.instefa.cafepickpos.ui.views.order.modifier.ModifierViewerTable(modifierSelectionModel.getTicketItem());
	...
	private void createTicketItemControlPanel() {
		...
		//		});
		//
		//		btnDecreaseAmount.setIcon(IconFactory.getIcon("minus.png")); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public ru.instefa.cafepickpos.ui.views.order.modifier.ModifierViewerTable getTicketViewerTable() {
