...
public class CategoryView extends SelectionView implements ActionListener {
	...
	public CategoryView() {
		super(ru.instefa.cafepickpos.POSConstants.CATEGORIES, PosUIManager.getSize(100), PosUIManager.getSize(80));
	...
	public void cleanup() {
		...
		buttonMap.clear();
		// 20170901, pymancer, annoying debug messages removal
        //PosLog.debug(CategoryView.class, Messages.getString("CategoryView.4")); //$NON-NLS-1$
