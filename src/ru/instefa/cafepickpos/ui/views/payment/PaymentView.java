...
import ru.instefa.cafepickpos.ui.dialog.MultiCurrencyTenderDialog;
...
public class PaymentView extends JPanel {
	...
	private ru.instefa.cafepickpos.swing.PosButton btnCash;
	private ru.instefa.cafepickpos.swing.PosButton btnPrint;
	private ru.instefa.cafepickpos.swing.PosButton btnCreditCard;
	private ru.instefa.cafepickpos.swing.PosButton btnDebitCard;
	private ru.instefa.cafepickpos.swing.PosButton btnGift;
	private ru.instefa.cafepickpos.swing.PosButton btnOther;

	private ru.instefa.cafepickpos.swing.TransparentPanel calcButtonPanel;
	private javax.swing.JLabel labelDueAmount;
	private javax.swing.JLabel labelTenderedAmount;
	private ru.instefa.cafepickpos.swing.TransparentPanel actionButtonPanel;
	private ru.instefa.cafepickpos.swing.PosButton btn7;
	private ru.instefa.cafepickpos.swing.PosButton btnDot;
	private ru.instefa.cafepickpos.swing.PosButton btn0;
	private ru.instefa.cafepickpos.swing.PosButton btnClear;
	private ru.instefa.cafepickpos.swing.PosButton btn8;
	private ru.instefa.cafepickpos.swing.PosButton btn9;
	private ru.instefa.cafepickpos.swing.PosButton btn4;
	private ru.instefa.cafepickpos.swing.PosButton btn5;
	private ru.instefa.cafepickpos.swing.PosButton btn6;
	private ru.instefa.cafepickpos.swing.PosButton btn3;
	private ru.instefa.cafepickpos.swing.PosButton btn2;
	private ru.instefa.cafepickpos.swing.PosButton btn1;
	private ru.instefa.cafepickpos.swing.PosButton btn00;
	private ru.instefa.cafepickpos.swing.PosButton btnNextAmount;

	private ru.instefa.cafepickpos.swing.PosButton btnAmount1;
	private ru.instefa.cafepickpos.swing.PosButton btnAmount2;
	private ru.instefa.cafepickpos.swing.PosButton btnAmount5;
	private ru.instefa.cafepickpos.swing.PosButton btnAmount10;
	private ru.instefa.cafepickpos.swing.PosButton btnAmount20;
	private ru.instefa.cafepickpos.swing.PosButton btnAmount50;
	private ru.instefa.cafepickpos.swing.PosButton btnAmount100;
	private ru.instefa.cafepickpos.swing.PosButton btnExactAmount;
	private ru.instefa.cafepickpos.swing.PosButton btnNoSale;
	...
	private void initComponents() {
		...
		calcButtonPanel = new ru.instefa.cafepickpos.swing.TransparentPanel();
		calcButtonPanel.setLayout(new MigLayout("wrap 4,fill, ins 0 0 4 0", "sg, fill", "sg, fill")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$

		btnNextAmount = new ru.instefa.cafepickpos.swing.PosButton();
		btnAmount1 = new ru.instefa.cafepickpos.swing.PosButton();
		btnAmount1.setFont(font2);

		btnAmount2 = new ru.instefa.cafepickpos.swing.PosButton();
		btnAmount2.setFont(font2);

		btnAmount5 = new ru.instefa.cafepickpos.swing.PosButton();
		btnAmount5.setFont(font2);

		btnAmount10 = new ru.instefa.cafepickpos.swing.PosButton();
		btnAmount10.setFont(font2);

		btnAmount20 = new ru.instefa.cafepickpos.swing.PosButton();
		btnAmount20.setFont(font2);

		btnAmount50 = new ru.instefa.cafepickpos.swing.PosButton();
		btnAmount50.setFont(font2);

		btnAmount100 = new ru.instefa.cafepickpos.swing.PosButton();
		btnAmount100.setFont(font2);

		btnExactAmount = new ru.instefa.cafepickpos.swing.PosButton();

		btnNoSale = new ru.instefa.cafepickpos.swing.PosButton();

		btn7 = new ru.instefa.cafepickpos.swing.PosButton();
		btn8 = new ru.instefa.cafepickpos.swing.PosButton();
		btn9 = new ru.instefa.cafepickpos.swing.PosButton();
		btn4 = new ru.instefa.cafepickpos.swing.PosButton();
		btn5 = new ru.instefa.cafepickpos.swing.PosButton();
		btn6 = new ru.instefa.cafepickpos.swing.PosButton();
		btn1 = new ru.instefa.cafepickpos.swing.PosButton();
		btn2 = new ru.instefa.cafepickpos.swing.PosButton();
		btn3 = new ru.instefa.cafepickpos.swing.PosButton();
		btn0 = new ru.instefa.cafepickpos.swing.PosButton();
		btnDot = new ru.instefa.cafepickpos.swing.PosButton();
		btnClear = new ru.instefa.cafepickpos.swing.PosButton();
		btn00 = new ru.instefa.cafepickpos.swing.PosButton();
		...
		btn7.setText("7");
		btn7.setFont(font2);
		//btn7.setIcon(IconFactory.getIcon("7.png")); // NOI18N //$NON-NLS-1$ //$NON-NLS-2$
		...
		btn8.setText("8");
		btn8.setFont(font2);
		//btn8.setIcon(IconFactory.getIcon("8.png")); // NOI18N //$NON-NLS-1$ //$NON-NLS-2$
		...
		btn9.setText("9");
		btn9.setFont(font2);
		//btn9.setIcon(IconFactory.getIcon("9.png")); // NOI18N //$NON-NLS-1$ //$NON-NLS-2$
		...
		btn4.setText("4");
		btn4.setFont(font2);
		//btn4.setIcon(IconFactory.getIcon("4.png")); // NOI18N //$NON-NLS-1$ //$NON-NLS-2$
		...
		btn5.setText("5");
		btn5.setFont(font2);
		//btn5.setIcon(IconFactory.getIcon("5.png")); // NOI18N //$NON-NLS-1$ //$NON-NLS-2$
		...
		btn6.setText("6");
		btn6.setFont(font2);
		//btn6.setIcon(IconFactory.getIcon("6.png")); // NOI18N //$NON-NLS-1$ //$NON-NLS-2$
		...
		btn1.setText("1");
		btn1.setFont(font2);
		//btn1.setIcon(IconFactory.getIcon("1.png")); // NOI18N //$NON-NLS-1$ //$NON-NLS-2$
		...
		btn2.setText("2");
		btn2.setFont(font2);
		//btn2.setIcon(IconFactory.getIcon("2.png")); // NOI18N //$NON-NLS-1$ //$NON-NLS-2$
		...
		btn3.setText("3");
		btn3.setFont(font2);
		//btn3.setIcon(IconFactory.getIcon("3.png")); // NOI18N //$NON-NLS-1$ //$NON-NLS-2$
		...
		btn0.setText("0");
		btn0.setFont(font2);
		//btn0.setIcon(IconFactory.getIcon("0.png")); // NOI18N //$NON-NLS-1$ //$NON-NLS-2$
		...
		btnDot.setIcon(IconFactory.getIcon("dot.png")); // NOI18N //$NON-NLS-1$ //$NON-NLS-2$
		...
		btnClear.setIcon(IconFactory.getIcon("clear.png")); // NOI18N //$NON-NLS-1$ //$NON-NLS-2$
		...
		btnNoSale.setText(Messages.getString("DrawerKickAction.0"));
		...
		btnGratuity = new PosButton(ru.instefa.cafepickpos.POSConstants.ADD_GRATUITY_TEXT);
		...
		btnDiscount = new PosButton(ru.instefa.cafepickpos.POSConstants.COUPON_DISCOUNT);
		...
		btnPrint = new ru.instefa.cafepickpos.swing.PosButton(POSConstants.PRINT_TICKET);
		...
		actionButtonPanel = new ru.instefa.cafepickpos.swing.TransparentPanel();
		...
		btnCash = new ru.instefa.cafepickpos.swing.PosButton(
				PosGuiUtil.getCenteredMultilineHtml(Messages.getString("PaymentView.31"))
			); //$NON-NLS-1$
		...
		PosButton btnMultiCurrencyCash = new ru.instefa.cafepickpos.swing.PosButton(Messages.getString("PaymentView.67")); //$NON-NLS-1$
		...
		btnCreditCard = new PosButton(PosGuiUtil.getCenteredMultilineHtml(Messages.getString("PaymentView.33"))); //$NON-NLS-1$
		...
		btnDebitCard = new PosButton(PosGuiUtil.getCenteredMultilineHtml(Messages.getString("PaymentView.34"))); //$NON-NLS-1$
		...
		btnOther = new PosButton(Messages.getString("PaymentView.68")); //$NON-NLS-1$
		...
		btnCancel = new ru.instefa.cafepickpos.swing.PosButton(POSConstants.CANCEL.toUpperCase());
	...
	private void doPayByCash() {
		try {
			...
			if (ticket == null || ticket.getTicketItems() == null || ticket.getTicketItems().size() == 0) {
				POSMessageDialog.showError(POSUtil.getFocusedWindow(), Messages.getString("PaymentView.69"));
				return;
			}
