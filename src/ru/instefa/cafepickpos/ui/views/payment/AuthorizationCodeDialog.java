...
import ru.instefa.cafepickpos.swing.FocusedTextField;
...
public class AuthorizationCodeDialog extends POSDialog implements CardInputProcessor {
	...
	private void createUI() {
		...
		btnVisaCard.setIcon(IconFactory.getIcon("visa_card.png")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$

		btnMasterCard = new POSToggleButton(""); //$NON-NLS-1$
		btnMasterCard.setIcon(IconFactory.getIcon("master_card.png")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$

		btnAmericanExpress = new POSToggleButton();
		btnAmericanExpress.setIcon(IconFactory.getIcon("am_ex_card.png")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$

		btnDiscoverCard = new POSToggleButton();
		btnDiscoverCard.setIcon(IconFactory.getIcon("discover_card.png")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		...
		btnDebitVisaCard.setIcon(IconFactory.getIcon("visa_card.png")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$

		btnDebitMasterCard = new POSToggleButton();
		btnDebitMasterCard.setIcon(IconFactory.getIcon("master_card.png")); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
