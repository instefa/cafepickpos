...
public class GroupPaymentView extends JPanel {
	...
	private void initComponents() {
		...
		PosButton btnPrint = new ru.instefa.cafepickpos.swing.PosButton(POSConstants.PRINT_TICKET);
		...
		btnOther = new PosButton(Messages.getString("PaymentView.67")); //$NON-NLS-1$
