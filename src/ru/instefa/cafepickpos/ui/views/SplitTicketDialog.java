...
import ru.instefa.cafepickpos.ui.views.order.TicketForSplitView;
...
public class SplitTicketDialog extends POSDialog {
	...
	private ru.instefa.cafepickpos.swing.POSToggleButton btnSplitBySeat;
	...
	private void createToolbarPanel() {
		...
		btnNumSplit2 = new ru.instefa.cafepickpos.swing.POSToggleButton();
		btnNumSplit3 = new ru.instefa.cafepickpos.swing.POSToggleButton();
		btnNumSplit4 = new ru.instefa.cafepickpos.swing.POSToggleButton();
		btnSplitBySeat = new ru.instefa.cafepickpos.swing.POSToggleButton();
		lblTicketId = new ru.instefa.cafepickpos.swing.POSTitleLabel();
        ...
        toolbarPanel.add(new JLabel(ru.instefa.cafepickpos.POSConstants.NUMBER_OF_SPLITS));
	...
	private void createTitlePanel() {
        ...
        titlePanel.setTitle(ru.instefa.cafepickpos.POSConstants.SPLIT_TICKET);
	...
	private synchronized void btnFinishActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFinishActionPerformed
		...
		try {
			...
			ActionHistoryDAO.getInstance().saveHistory(Application.getCurrentUser(), ActionHistory.SPLIT_CHECK,
					ru.instefa.cafepickpos.POSConstants.RECEIPT_REPORT_TICKET_NO_LABEL + ":" + ticket4.getId()); //$NON-NLS-1$
    ...
    private ru.instefa.cafepickpos.swing.POSToggleButton btnNumSplit2;
    private ru.instefa.cafepickpos.swing.POSToggleButton btnNumSplit3;
    private ru.instefa.cafepickpos.swing.POSToggleButton btnNumSplit4;
    private ru.instefa.cafepickpos.swing.POSTitleLabel lblTicketId;
    private ru.instefa.cafepickpos.ui.views.order.TicketForSplitView mainTicketView;
    private ru.instefa.cafepickpos.ui.views.order.TicketForSplitView ticketView2;
    private ru.instefa.cafepickpos.ui.views.order.TicketForSplitView ticketView3;
    private ru.instefa.cafepickpos.ui.views.order.TicketForSplitView ticketView4;
	...
	public void setTicket(Ticket ticket) {
		this.ticket = ticket;
		if (ticket != null) {
			lblTicketId.setText(ru.instefa.cafepickpos.POSConstants.ORIGINAL_TICKET_ID + ": " + ticket.getId()); //$NON-NLS-1$
