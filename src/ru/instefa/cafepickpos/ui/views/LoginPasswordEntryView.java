...
class LoginPasswordEntryView extends JPanel {
	...
	private void initComponents() {
		...
		btnShutdown = new ru.instefa.cafepickpos.swing.PosButton();
...
//		modePanel.add(btnCashierMode);
		...
		if (TerminalConfig.isShowDbConfigureButton()) {
			btnConfigureDatabase = new ru.instefa.cafepickpos.swing.PosButton();
			btnConfigureDatabase.setAction(goAction);
			btnConfigureDatabase.setText(ru.instefa.cafepickpos.POSConstants.CONFIGURE_DATABASE);
		...
		btnShutdown.setText(ru.instefa.cafepickpos.POSConstants.SHUTDOWN);
	...
	Action goAction = new AbstractAction() {
		public void actionPerformed(ActionEvent e) {
			...
			if (ru.instefa.cafepickpos.POSConstants.LOGIN.equals(command)) {
				doLogin();
			}
			else if (ru.instefa.cafepickpos.POSConstants.SHUTDOWN.equals(command)) {
